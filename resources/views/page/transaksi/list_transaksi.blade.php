...
<div class="p-30 bg-white">
    <form id="cariListTransaksi">
        <div class="row">
            ...
            <div class="col-2">
                <label for="keyword" class="control-label">Status Transaksi :</label>
            </div>
        </div>
        <div class="row">
            <div class="col-3">
            ...
            <div class="col-2">
                <select class="form-control" id="select_status" name="select_status" required>
    ...
    <script>
        ...
        function dataTable(){
            $('#list_transaksi').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url" : "/transaksi/get_list_transaksi",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
        ...
        function updateStatusRefund(id_trx){
            Swal.fire({
                    title: 'Refund Transaksi!',
                    icon: 'warning',
                    text: "Proses ini akan refund dana transaksi.",
                    input: 'text',
                    inputAttributes: {
                        autocapitalize: 'off',
                    ...
                    if (result.value) {
                        // $('body').loading('stop');
                        $.ajax({
                            url: "/transaksi/update_status_refund",
                            method: 'POST',
                            dataType: 'json',
                            data: {
                                "_token": "<?= csrf_token()?>",
