...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor">Refund Dana Transaksi</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Laporan</a></li>
            <li class="breadcrumb-item active">Refund Dana Transaksi</li>
        </ol>
    </div>
</div>

<div class="p-30 bg-white">
    <form id="cariRefundTransaksi">
        <div class="row">
            <div class="col-3">
        ...
        <div class="row">
            ...
            <div class="col-2">
                <select class="form-control" id="target_search" name="target_search" required>
                    ...
                    <option value="tujuan">Nomor Tujuan</option>
                    <option value="transaksi_code">Nomor Invoice</option>
    ...
    <div class="table-responsive">
        <table id="refund_transaksi" class="table table-hover table-bordered">
            <thead>
                <tr>
                    <th>Tanggal</th>
                    <th>Data Member</th>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#cariRefundTransaksi").submit(function(event) {
                event.preventDefault();
                $('#refund_transaksi').DataTable().destroy();
                custom_search = true;
                dataTable();
            });
        ...
        function dataTable(){
            $('#refund_transaksi').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url" : "/laporan/get_refund_transaksi",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                ...
                "columns": [
                    ...
                    {"data": "info_pembelian"},
                    {"data": "supplier"},
                    {"data": "keterangan", "className": "w-25"}
                ],
